...
void applyCudaEqualizer(float* real, float* imag, int numSamples, int sampleRate) {
    ...
    float gains[3] = {
        std::pow(10.0f, LOW_GAIN / 20.0f),  
        std::pow(10.0f, MID_GAIN / 20.0f),   
        std::pow(10.0f, HIGH_GAIN / 20.0f)  
    };
...
int main(int argc, char* argv[]) {
    const char* inputFile = "/content/drive/MyDrive/fullSong.wav";
    const char* outputFile = "/content/drive/MyDrive/fullSongEQ_CUDA.wav";
    SF_INFO sfInfo{};
