...
/*
    ...
    HOW TO COMPILE: g++ -o lpf lpf.cpp -lfftw3 -lsndfile -msse2 -O3
           RUN:     ./lpf <cutoff-frequency [Hz]>
*/
...
int main(int argc, char* argv[]) {
    ...
    const char* outputFile = "./samples/drumsLPF.wav";
    SF_INFO sfInfo;
    ...
    std::ofstream logParallel("log/lpf_parallel.txt");
    std::ofstream logSequential("log/lpf_sequential.txt");
    std::ofstream SpeedUp("log/lpf_speedup.txt");
